...
//           <Button
//             text="Login"
//             className="border border-[#1E3A8A] text-[#1E3A8A] hover:bg-[#1E3A8A] hover:text-white cursor-pointer font-roboto rounded-2xl"
//           />
//           <Button
//             text="Sign Up"
//             className="bg-[#1E3A8A] text-white hover:rounded-none hover:border-y hover:border-y-[#1E3A8A] hover:bg-white hover:text-[#1E3A8A] cursor-pointer font-roboto rounded-2xl"
//           />
//         </div>
...
//             <Buttons
//               text="Login"
//               className="border border-[#1E3A8A] text-[#1E3A8A] hover:bg-[#1E3A8A] hover:text-white cursor-pointer font-roboto rounded-2xl w-full"
//               onClick={closeMenu}
//             />
//             <Buttons
//               text="Register"
