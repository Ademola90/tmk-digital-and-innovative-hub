...
const ContactHero: React.FC = () => {
  return (
    <div
      className="min-h-[400px] md:min-h-[500px] bg-cover bg-center bg-no-repeat text-white flex items-center justify-center px-5 md:px-20 py-20 relative"
      style={{
        backgroundImage: `linear-gradient(rgba(30, 58, 138, 0.7), rgba(37, 99, 235, 0.7)), url('https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=600&fit=crop')`,
      }}
    >
